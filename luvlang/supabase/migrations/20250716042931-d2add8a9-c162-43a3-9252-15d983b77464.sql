-- First check the current table structure and recreate properly
-- Drop the table and recreate it without the generated column issue
DROP TABLE IF EXISTS membership_plans CASCADE;

-- Recreate membership_plans table with proper structure
CREATE TABLE membership_plans (
  ...
  highlight_color VARCHAR(20) DEFAULT '#FF6B6B',
...
CREATE POLICY "Public plan access" ON membership_plans
