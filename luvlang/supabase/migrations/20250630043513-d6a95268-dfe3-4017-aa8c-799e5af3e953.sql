...
-- Fix the migration by removing the PRIMARY KEY constraint from the id column
-- The user_matches table already has a primary key
...
-- Add missing columns to user_matches table (without PRIMARY KEY since it already exists)
